...
#     assert check_weather(5.00) == "avarage", 'temperatures between 10 and 20 degree \
...
#     assert check_weather(13.00) == "average", 'temperatures between 10 and 20 degree must be considered as average'
